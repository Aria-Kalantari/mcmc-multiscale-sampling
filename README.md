...
state implements **M1 + M2 + M3 + M4 + M5**: the static local-conditioning core
...
repeated-conditioning instability and compares the M5 stability fixes.
...
Not implemented yet: Streamlit or Phase 2 generalization.
